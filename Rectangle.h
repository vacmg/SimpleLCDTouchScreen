...
public:
    ...
    Rectangle(int x, int y, int x1, int y1, Color mainColor, Color secondaryColor, Label* label, bool autoSizeEnabled);
    ...
    Rectangle(int x, int y, int x1, int y1, Color mainColor, Label* label, bool autoSizeEnabled);
