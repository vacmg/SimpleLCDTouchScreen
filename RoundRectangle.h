...
public:
    ...
    RoundRectangle(int x, int y, int x1, int y1, uint8_t radius, Color mainColor, Color secondaryColor, Label* label, bool autoSizeEnabled);
    ...
    RoundRectangle(int x, int y, int x1, int y1, uint8_t radius, Color mainColor, Label* label, bool autoSizeEnabled);
