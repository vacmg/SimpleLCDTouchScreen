...
//********************************************************************************
//=========================================电源接线================================================//
//5V接DC 5V电源   3V3接DC 3.3V电源
//GND接地
//=======================================液晶屏数据线接线==========================================//
//本模块默认数据总线类型为8位并口
//液晶屏模块             C51单片机
// LCD_D0~LCD_D7 接       P00~P07        //8位并口数据总线
//=======================================液晶屏控制线接线==========================================//
//液晶屏模块             C51单片机
// LCD_CS        接        P13           //片选控制信号
// LCD_RST       接        P33           //复位信号
...
void main_test(void)
{
	...
	Gui_StrCenter(0,90,MAGENTA,BLUE,"3.95\" ST7796S 320X480",16,1);//居中显示
	Gui_StrCenter(0,120,BLUE,BLUE,"xiaoFeng@QDtech 2019-03-04",16,1);//居中显示
	delay_ms(1500);		
	delay_ms(1500);
}
